...
int sample_correction_precent = SAMPLE_CORRECTION_PERCENT_MAX;
...
//                    max_nb_samples = ((nb_samples * (100 + SAMPLE_CORRECTION_PERCENT_MAX) / 100));
                    min_nb_samples = ((nb_samples * (100 - sample_correction_precent ) / 100));
                    max_nb_samples = ((nb_samples * (100 + sample_correction_precent ) / 100));
                    wanted_nb_samples = av_clip(wanted_nb_samples, min_nb_samples, max_nb_samples);
                } else{
		    //acp
		    sample_correction_precent = 4;
...
static VideoState *stream_open(FFPlayer *ffp, const char *filename, AVInputFormat *iformat)
{
    ...
    //acp
    sample_correction_precent = SAMPLE_CORRECTION_PERCENT_MAX;
